...
{	
  ...
  if($invoice_no == NULL) $invoice_no = 1;
   ...
   //if($stl_key == $_SESSION['stl_key']) {
        ...
        $sql = "INSERT INTO order_list_temp SET varient_type='$v_str',product_id='$pro_id',  session_id='$session_id', user_id='', merchant_id='$m_id', quantity='$qty_list', amount='$p_price',product_code='$p_code', remark='$option', location='".$location."', table_type='".$table_type."',section_type='$section_type',created_on='$date', invoice_no='$invoice_no'";
         ...
         if($error == ""){
            ...
            if($guest_permission == "0"){
              ...
              // $user_total = mysqli_fetch_assoc(mysqli_query($conn, "SELECT MAX(id) as id FROM `users` WHERE user_roles = '3'"));
			   ...
			   // die;
               // $upt_tt = mysqli_query($conn,"UPDATE `order_list` SET 'user_id'=' $user_id','user_name'='$name','user_mobile'='$cm' WHERE id = '$o_id' ");
