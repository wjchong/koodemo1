...
if($product['pro_ct'] > 0) { ?>
    <div class="col-md-12 merchant-layout-2" style="margin-bottom:2%;">
                                        ...
                                        <div class="col-md-5 col-sm-5">
											...
											<?php if($product_zoom){ ?>
											    <?php
											        ...
											        $variableA2=$row['product_price'];
											    ?>
											    <a class="adminDemoVideo" href="https://koofamilies.com/images/product_images/<?php echo $row['image']; ?>" data-fancybox data-caption="<div class='card' style='text-align:center;'>
                                                    ...
                                                    <img src="https://koofamilies.com/images/product_images/<?php echo $row['image']; ?>" />
                                                </a>
											<?php } else { ?>
