                            ...
                            <div class="widget-body clearfix">
                                <table class="table table-striped" data-toggle="datatables">
                                    ...
                                    <tbody>
										...
										if (count($rolevals) > 0): $count = 0; ?>
                                            <?php 
											 $i=1;
											foreach($rolevals as $roleval):
                                              
											?>
                                               
                                                <tr>
												 <td><?php echo $i;?></td>
                                                    <td><?=$roleval['assist_type']; ?></td>
                                                    <td><?=$roleval['createdate']; ?></td>
                                                    
                                                    <td>
                                                         <div class="btn-group dropup m-r-10">
                                                            <button aria-expanded="false" data-toggle="dropdown" class="btn btn-color-scheme dropdown-toggle ripple" type="button">Take Action <span class="caret"></span>
                                                            </button>
                                                            <div role="menu" class="dropdown-menu animated fadeInUp">
                                                                <a class="dropdown-item" href="<?= base_url('admin') ?>/assistant/edit_assist_type/<?=$roleval['id']; ?>">Edit</a>  
                                                               
                                                                <div class="dropdown-divider"></div>
                                                               
                                                                <a class="dropdown-item" href="javascript:deleteMember('<?= base_url('admin/assistant/delete_assist_type') ?>/<?= $roleval['id']; ?>')"><strong>Delete</strong></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
