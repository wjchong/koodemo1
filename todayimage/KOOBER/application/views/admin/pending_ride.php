                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Pending Ride</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">JUST REQUESTED , NOT YET BOOKED RIDES</h3>
                                    </div>
                      ...
                      $username = $this->admin_common_model->get_where('users',['id'=>$row['user_id']]);
                                   ...
                                   ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"> <a href="<?=base_url('admin/view_page/view_pending_ride/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-eye"></i></a> </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
