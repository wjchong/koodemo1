...
$userList = $this->admin_common_model->get_all('car_list');
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              <?php $i=2; foreach($userList as $row){ ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $row['per_helper_charge']; ?></td>
                                                            <td><?= $row['insurance_policy_charge']; ?></td>
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_vehicle/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>  <a href="<?=base_url('admin/view_page/view_vehicle/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-eye"></i></a> </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
