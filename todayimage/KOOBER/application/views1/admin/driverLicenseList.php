...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('drivers_license' );
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Drivers License </span> <a href="<?=base_url('admin/view_page/addDriverLicense');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                    <sapn><p><?= $row['license_no']; ?></p></p>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addDriverLicense/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'drivers_license', 'id': id}, // change this to send js object
          type: "POST",
