...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('user_request');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Order </span>   
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      $driver = $this->admin_common_model->get_where('drivers',['id'=>$row['accept_driver_id']]);
               ...
               ?>
                ...
                <td><p><?= $username[0]['username']; ?></p></td>
                <td><p><?= $driver[0]['first_name']; ?></p></td>
                <td><p><?= $row['date']; ?></p></td>
                <td><p><?= $row['time']; ?></p></td>
                ...
                <td><div class="col-sm-2">
                       <?php
                        if ($row['item_image'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['item_image']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="40"> 
                    </div> </td>
                <td><p><?= $row['quantity']; ?></p></td>
                <td><p><?= $row['weight']; ?></p></td>
                <td><p><?= $row['reciever_phone']; ?></p></td>
