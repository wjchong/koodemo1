...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('driver_national_id' );
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Drivers License </span> <a href="<?=base_url('admin/view_page/addDriverNationalNo');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                    <sapn><p><?= $row['national_id_no']; ?></p></p>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addDriverNationalNo/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'driver_national_id', 'id': id}, // change this to send js object
          type: "POST",
