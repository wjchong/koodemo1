...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Events </span> <a href="<?=base_url('admin/view_page/addEvent');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                       <?php
                        if ($row['event_image'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['event_image']);
                        }
                      ?>
                    ...
                    <sapn><?= $row['event_name']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addEvent/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
