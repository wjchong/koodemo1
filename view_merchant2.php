          ...
          <?php } ?>
                     ...
                     <?php
                        if($merchant_detail['menu_type']==2){
                            include 'view_merchant_layout22.php';
                        } else {  
                            include 'view_merchant_layout11.php';
                        }
                    ?>  
    ...
    <th><?php echo $language['unit_price']; ?></th>
	  ...
	  <?php if($merchant_detail['order_extra_charge']>0){ ?>
	     <div class="" style="display:none;" id="delivery_label">  
			<div style="/*! display:grid; */grid-template-columns:.2fr 2fr;grid-column-gap: 10px;vertical-align: middle;align-content:center;font-weight: bold;font-size: 18px;margin-top:1%;">
				<?php $deliver_charges_label="Delivery Charge"; ?>
			   
				<?php  echo ucfirst(strtolower($deliver_charges_label)); ?>: Rm <?php echo number_format($merchant_detail['order_extra_charge'],2); ?>
			</div>
   ...
   <div class="modal fade" id="ProductModel" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
			  ...
			  <div class="modal fade" id="same_order_model" role="dialog">
        <div class="modal-dialog">
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-header">
								...
								<div class="modal-body" style="padding-bottom:0px;">
									<div class="col-md-12" style="text-align: center;">
									  <h5><?php echo $language['same_order_alert']; ?> </h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body" style="padding-bottom:0px;">
                        <div class="col-md-12" style="text-align: center;">
                          <h5>This merchant require your permission for location in order to place order </h5>
						  <p style="color:red;">Note: To allow location please clear your  cache history</p>
				...
				<h4>Please choose your wallet to pay</h4>
				 ...
				 <p class="select_label" style="display:none;">Selected Wallet : <span id='wallet_name'></span></br>
				    <?php if($merchant_detail['order_extra_charge']>0){ $s_label="Product";} else { echo "Total";}?>
					 ...
					 <?php echo $s_label;?> Amount: Rm <span id="total_cart_amount_label" style="font-weight: bold;color: black;"></span></br>
					  <?php if($merchant_detail['order_extra_charge']>0){  ?>
					  Delivery Charge: Rm <span id="delivery_cart_amount_label" style="font-weight: bold;color: black;"></span></br>
					  Final Amount: Rm <span id="final_cart_amount_label" style="font-weight: bold;color: black;"></span></br>
...
$_SESSION['same_order']='';	
$shortcut_icon="images/shortcut_icon/".$merchant_detail['shortcut_icon'];
if($shortcut_icon=='')
           ...
           // alert(to_long);   
            ...
            $('#map_range').html(location_range);
             ...
             else
             {
			    ...
			    var delivery_charges="<?php echo $merchant_detail['order_extra_charge']; ?>";
				var free_delivery="<?php echo $merchant_detail['free_delivery']; ?>";
				// alert('Delivery Charge: '+delivery_charges);
