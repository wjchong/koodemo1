...
if(isset($_POST['signup']))
{
	...
	if($error == "")
	{
		...
		$reffered_by= $_POST['referral_id'];
	     ...
	     $q="INSERT INTO users SET dob='$dob', isLocked='1', name='$name',user_roles='$user_role', password='$password', joined='".time()."', verification_code='$code', referral_id='$ref',referred_by='$reffered_by',security_answer= '$security',security_questions= '$questions',fund_password='$fund_pass',email='$email',mobile_number='$cm'";
...
-->
    ...
    <?php if($_GET['invitation_id']=="Life Ricette Cafe Patisserie 5d706a7ce199f"){ ?>
        <img src="<?php echo $site_url; ?>/images/life.jpg" width="170px" height="100px" class="logo_main">
	<?php } else { ?>
