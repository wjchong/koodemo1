                    ...
                    foreach ($categories as $category)
                    {
                        ...
                        while ($row = mysqli_fetch_assoc($sub_categories_q))
                        {
                            ...
                            ?>
                                ...
                                <button class="btn btn-primary" type="button" data-filter=".<?php echo $row['id'];?>"><?php echo str_replace("-", " ", $row['category_name']);?></button>
                            </div>
                        <?php $s++;  }
                        $index++;
                    }
                            ...
                            <div class="element-item grid-item  <?php echo $row['category_id'];?>" >
                                <form action="#" method="post" class= "set_calss" data-id = "<?php echo $row['id'] ?>" data-code = "<?php echo $row['product_type'] ?>"  data-pr = "<?php echo $row['product_price'] ?>">
                                    ...
                                    <?php } ?>
                                            ...
                                            <button role="button" class="introduce-remarks btn btn-large btn-primary" data-toggle="modal" data-target="#remarks_area" disabled="disabled">Remarks</button>
                                            ...
                                            if(!empty($row['image'])){
                                                ...
                                                ?>
                                                  <p  id="product_child_<?php echo $row['id']?>" class="text_add_cart <?php echo $cart_class ?>"  data-id = "<?php echo $row['id'] ?>" data-code = "<?php echo $row['product_type'] ?>"  data-pr = "<?php echo $row['product_price'] ?>" data-name = "<?php echo $row['product_name'] ?>">
