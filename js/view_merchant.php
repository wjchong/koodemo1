...
<body class="header-light sidebar-dark sidebar-expand pace-done">
  ...
  <div style="float:left;width:100%;top:0;">
    ...
    <div style="float:left;width:20%;">
        ...
        ?>
			<?php } else { ?>
					    	  <h5 class="favorite_name" style="display: inline-blick;margin-left:1%;">We are temporary closed for online order now. Please try later. Sorry for any inconvenient  </h5>
