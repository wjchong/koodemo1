                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
							...
							<?php  print_r($edit_data); ?>
                                <h5 class="box-title mr-b-0"><?php if(count($edit_data) > 0) {  echo "Update Product Category"; ?>  <?php }else{ echo "Add Product Category";} ?></h5>
                             
                            
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l10"> <?php if(count($edit_data) > 0) {  echo "Update Product Category"; ?>  <?php }else{ echo "Add Product Category";} ?>  </label>
                                        <div class="col-md-9">
                                            <input class="form-control" name="category" id="category_assign" placeholder="Product Category" type="text"  <?php if(count($edit_data) > 0) {  ?> value="<?php echo $edit_data[0]['category']; ?>" <?php } ?>>
                                    ...
                                    <div class="form-actions">
                                        <div class="form-group row">
                                            <div class="col-md-9 ml-md-auto btn-list">
											   ...
											   <?php } else { ?>
											   onclick="addcategory()" <?php } ?>>Submit</a>
                                            </div>
                                        </div>
                                    </div>
...
{
    //var id = $('#ids').val();
    var category = $('#category_assign').val();
   
	if(category==""){
			swal("Validation!", "Please enter category", "error");
		return false;
	}else{
	
			$.ajax({
					  method: "POST",
					  url: "<?php echo base_url();?>admin/Vendors/addcategory",
               ...
               window.location = "<?php echo base_url();?>admin/Vendors/manage_category";
            });
...
function updatecategory()
{
	...
	if(category==""){
		...
		return false;
			...
			$.ajax({
					  method: "POST",
					  url: "<?php echo base_url();?>admin/Vendors/updatecategory",
