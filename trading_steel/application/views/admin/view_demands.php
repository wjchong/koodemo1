            ...
            <div class="row page-title clearfix">
                ...
                <div class="page-title-right d-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">View demands</li>
                    </ol>
                                                    ...
                                                    <td>
                                                         <div class="btn-group dropup m-r-10">
                                                            ...
                                                            <div role="menu" class="dropdown-menu animated fadeInUp">
                                                                ...
                                                                <a class="dropdown-item" href="javascript:blockMember('<?= base_url('admin/members/block_member') ?>/<?= $row->id; ?>/<?php echo $block; ?>/verified_members')"><strong><?php echo $block; ?></strong></a>
                                                                <a class="dropdown-item" href="javascript:deleteMember('<?= base_url('admin/members/delete_member') ?>/<?= $row->id; ?>/verified_members')"><strong>Delete</strong></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
