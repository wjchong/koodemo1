                                                    ...
                                                    <td>
                                                         <div class="btn-group dropup m-r-10">
                                                            ...
                                                            <div role="menu" class="dropdown-menu animated fadeInUp">
                                                                <a class="dropdown-item" href="<?= base_url('admin') ?>/Vendors/edit_category/<?=$roleval['id']; ?>">Edit</a>  
                                                               
                                                                <div class="dropdown-divider"></div>
                                                               
                                                                <a class="dropdown-item" href="javascript:deleteMember('<?= base_url('admin/Vendors/delete_category') ?>/<?= $roleval['id']; ?>')"><strong>Delete</strong></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
