                                    ...
                                    <tbody>
										 ...
										 if (count($assisvals) > 0): $count = 0; ?>
                                            <?php foreach ($assisvals as $assisval): ?>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo $assisval['apply_category']; ?></td>
                                                    ...
                                                    <td>
                                                         <div class="btn-group dropup m-r-10">
                                                            ...
                                                            <div role="menu" class="dropdown-menu animated fadeInUp">
                                                                ...
                                                                <a class="dropdown-item" href="javascript:blockMember('<?= base_url('admin/Vendors/block_vendor') ?>/<?= $assisval['id']; ?>/<?php echo $block; ?>/manage_vendor')"><strong><?php echo $block; ?></strong></a>
																
																 <a class="dropdown-item" href="<?= base_url('admin') ?>/Vendors/edit_vendor/<?=$assisval['id']; ?>"><strong>Edit</strong></a>
                                                                <a class="dropdown-item" href="javascript:deleteMember('<?= base_url('admin') ?>/Vendors/delete_vendor/<?=$assisval['id']; ?>')"><strong>Delete</strong></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
