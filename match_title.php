...
$m_id=$_SESSION['login'];
$query = "SELECT title FROM coupon where  user_id='$m_id' and status='1'";
...
<?php if (!$exists): ?>
	<span style="color: green">
		<i class="fa fa-check mr-2" aria-hidden="true"></i> Title is okay!
	</span>
	<script>
...
<?php if ($exists): ?>
	<span style="color: red">
		<i class="fa fa-times mr-2" aria-hidden="true"></i> Title Already Exists!
	</span>
		<script>
$('document').ready(function() {
