...
// }else{
    ...
    // }
// }
$total_rows = mysqli_query($conn, "SELECT order_list.*, users.mobile_number FROM order_list inner join users on order_list.user_id = users.id WHERE merchant_id ='".$_SESSION['login']."' ORDER BY `created_on` DESC LIMIT 0,15");
$total_rows1 = mysqli_query($conn, "SELECT order_list.*, users.mobile_number FROM order_list inner join users on order_list.user_id = users.id WHERE merchant_id ='".$_SESSION['login']."' ORDER BY `created_on` DESC LIMIT 0,15");
...
<div id="wrapper" class="wrapper">
    ...
    <div class="content-wrapper">
	   ...
	   $sql = "select order_list.invoice_no,order_list.id,order_list.section_type,order_list.table_type,sections.name from order_list inner join sections on order_list.section_type=sections.id where order_list.status in(0,2) and order_list.merchant_id='$Merchantid' order by sections.name asc limit 0,30";
